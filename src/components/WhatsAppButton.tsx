...
const WhatsAppButton = () => {
  ...
  const handleWhatsAppClick = () => {
    ...
    const message = "Hola! Me interesa conocer más sobre sus servicios de herrería.";
  ...
  return (
    <div className="fixed bottom-20 right-6 z-50">
      ...
      >
        ...
        {/* Tooltip */}
        {isHovered && (
          <div className="absolute bottom-full right-0 mb-2 px-3 py-1 bg-gray-900 text-white text-sm rounded-lg whitespace-nowrap transform translate-x-2">
