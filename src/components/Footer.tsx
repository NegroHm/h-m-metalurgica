      ...
      <div className="container mx-auto px-6">
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-primary-foreground/80 leading-relaxed">
              Maestros artesanos creando herrería excepcional con técnicas tradicionales y precisión moderna.
            </p>
          ...
          <div>
            ...
            <div className="space-y-2 text-primary-foreground/80">
              ...
              <p>
                <span className="font-medium">Taller:</span><br />
                123 Artisan Way<br />
        ...
        <div className="border-t border-primary-foreground/20 mt-12 pt-8 text-center">
          <p className="text-primary-foreground/60">
            © 2024 Héctor Medina. Todos los derechos reservados. | Hecho a mano con pasión.
          </p>
        </div>
      </div>
    </footer>
